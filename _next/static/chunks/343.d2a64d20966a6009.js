        ...
        75740: function(e, t, s) {
            ...
            let r = Symbol(),
                ...
                [p] = ((e = Object.is, t = (e, t) => new Proxy(e, t), s = e => c(e) && !u.has(e) && (Array.isArray(e) || !(Symbol.iterator in e)) && !(e instanceof WeakMap) && !(e instanceof WeakSet) && !(e instanceof Error) && !(e instanceof Number) && !(e instanceof Date) && !(e instanceof String) && !(e instanceof RegExp) && !(e instanceof ArrayBuffer), r = e => {
                    ...
                    let i = p[0],
                        ...
                        g = p[1],
                        b = (e = ++p[1]) => (g === e || h.size || (g = e, v.forEach(([t]) => {
                            let s = t[1](e);
                            s > i && (i = s)
                        })), i),
                        y = e => (t, s) => {
                        ...
                        W = {
                            ...
                            set(t, r, o, a) {
                                ...
                                if (o instanceof Promise) o.then(e => {
                                    o.status = "fulfilled", o.value = e, m(["resolve", [r], e])
                                }).catch(e => {
                                    o.status = "rejected", o.reason = e, m(["reject", [r], e])
                                });
                                else {
                                    !d.has(o) && s(o) && (h = f(o));
                                ...
                                return Reflect.set(t, r, h, a), m(["set", [r], o, p]), !0
                            }
                        },
                        E = t(O, W);
                    n.set(r, E);
            ...
            let m = f({
                ...
                O = {
                    ...
                    setConfig(e) {
                        var t, s;
                        v.initialize(), C.setChains(e.chains), C.setIsAuth(!!e.enableAuthMode), C.setIsCustomMobile(!!(null == (t = e.mobileWallets) ? void 0 : t.length)), C.setIsCustomDesktop(!!(null == (s = e.desktopWallets) ? void 0 : s.length)), b.setModalVersionInStorage(), Object.assign(I, e)
                    }
                };
            ...
            let $ = b.isMobile(),
                ...
                H = {
                    ...
                    async getRecomendedWallets() {
                        ...
                        if (b.isArray(e)) {
                            ...
                            let {
                                chains: e,
                                isAuth: s
                            } = C.state, r = e?.join(","), o = b.isArray(t), a = {
                                page: 1,
                    ...
                    async getWallets(e) {
                        ...
                        o.length ? t.excludedIds = o.map(e => e.id).join(",") : b.isArray(s) && (t.excludedIds = s.join(",")), b.isArray(r) && (t.excludedIds = [t.excludedIds, r].filter(Boolean).join(",")), C.state.isAuth && (t.sdks = "auth_v1");
                        let {
                            page: a,
                            search: n
                        } = e, {
                ...
                z = {
                    ...
                    open: async e => new Promise(t => {
                        ...
                        if (b.removeWalletConnectDeepLink(), C.setWalletConnectUri(e?.uri), C.setChains(e?.chains), g.reset("ConnectWallet"), s && r) K.open = !0, t();
                        else {
                            let e = setInterval(() => {
                                let s = C.state;
